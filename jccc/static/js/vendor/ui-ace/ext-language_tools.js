ace.define("ace/ext/language_tools", ["require", "exports", "module", "ace/snippets", "ace/autocomplete", "ace/config", "ace/autocomplete/text_completer", "ace/editor"], function (e, t, n) {
    var r = e("../snippets").snippetManager, i = e("../autocomplete").Autocomplete, s = e("../config"), o = e("../autocomplete/text_completer"), u = {getCompletions: function (e, t, n, r, i) {
        ...
        [o, "_"].forEach(function (e) {
            ...
            for (var n = t.length; n--;) {
                ...
                if (!i)continue;
                a.push({caption: i, snippet: r.content, meta: r.tabTrigger && !r.name ? r.tabTrigger + "⇥ " : "snippet"})
            }
        }, this), s(null, a)
    }}, f = [a, o, u];
    ...
    (function () {
        this.$init = function () {
            ...
            if (!n) {
                ...
                s.top += o.top - r.layerConfig.offset, s.left += o.left, s.left += r.$gutterLayer.gutterWidth, this.popup.show(s, i)
            }
        }, this.detach = function () {
            this.editor.keyBinding.removeKeyboardHandler(this.keyboardHandler), this.editor.off("changeSelection", this.changeListener), this.editor.off("blur", this.changeListener), this.editor.off("mousedown", this.mousedownListener), this.editor.off("mousewheel", this.mousewheelListener), this.changeTimer.cancel(), this.popup && this.popup.hide(), this.activated = !1, this.completions = this.base = null
    ...
    var r = e("../edit_session").EditSession, i = e("../virtual_renderer").VirtualRenderer, s = e("../editor").Editor, o = e("../range").Range, u = e("../lib/event"), a = e("../lib/lang"), f = e("../lib/dom"), l = function (e) {
        ...
        n.focus = r, n.$isFocused = !0, n.renderer.$cursorLayer.restartTimer = r, n.renderer.$cursorLayer.element.style.opacity = 0, n.renderer.$maxLines = 8, n.renderer.$keepTextAreaAtCursor = !1, n.setHighlightActiveLine(!1), n.session.highlight(""), n.session.$searchHighlight.clazz = "ace_highlight-marker", n.on("mousedown", function (e) {
            ...
            n.moveCursorToPosition(t), n.selection.clearSelection(), c.start.row = c.end.row = t.row, e.stop()
        });
        ...
        return d.$tokenizeRow = function (e) {
            ...
            var s = this.container, o = window.innerHeight, u = this.renderer, a = u.$maxLines * t * 1.4, f = e.top + this.$borderSize;
            f + a > o - t && !r ? (s.style.top = "", s.style.bottom = o - f + "px", n.isTopdown = !1) : (f += t, s.style.top = f + "px", s.style.bottom = "", n.isTopdown = !0), s.style.left = e.left + "px", s.style.display = "", this.renderer.$textLayer.checkForSizeChanges(), this._signal("show"), i = null, n.isOpen = !0

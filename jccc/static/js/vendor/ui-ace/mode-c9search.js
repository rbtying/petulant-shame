    ...
    var r = e("../lib/oop"), i = e("../lib/lang"), s = e("./text_highlight_rules").TextHighlightRules, u = function () {
        this.$rules = {start: [
            {tokenNames: ["c9searchresults.constant.numeric", "c9searchresults.text", "c9searchresults.text", "c9searchresults.keyword"], regex: "(^\\s+[0-9]+)(:\\s)(.+)", onMatch: function (e, t, n) {
                ...
                o && u ? r = u.split(o) : r = [u];
                for (var a = 0, f = r.length; a < f; a += 2)r[a] && s.push({type: i[2], value: r[a]}), r[a + 1] && s.push({type: i[3], value: r[a + 1]});
                return s
            }},
            ...
            {regex: "Searching for .*$", onMatch: function (e, t, n) {
                ...
                /regex/.test(u) || (s = i.escapeRegExp(s)), /whole/.test(u) && (s = "\\b" + s + "\\b");
                ...
                r[2] !== " in" && l.push({value: "'" + r[f++] + "'", type: "text"}, {value: r[f++], type: "text"}), l.push({value: " " + r[f++] + " ", type: "text"}), r[f + 1] ? (l.push({value: "(" + r[f + 1] + ")", type: "text"}), f += 1) : f -= 1;

(function () {
    ...
    function o(e, t, n) {
        ...
        if (!i.isMac && u) {
            ...
            if (n === 18 || n === 17) {
                ...
                if (n === 17 && o === 1)a = t.timeStamp; else if (n === 18 && s === 3 && o === 2) {
                    var f = -a;
    ...
    (function () {
        r.implement(this, d), this.$initOperationListeners = function () {
            ...
            e || (this.previousCommand = null, e = {}), this.$opResetTimer.schedule(), this.curOp = {command: e.command || {}, args: e.args};
            ...
            if (t.getDocument().isNewLine(e)) {
                ...
                t.insert({row: r.row + 1, column: 0}, h)
            }
    ...
    }).call(l.prototype), f.defineOptions(l.prototype, "mouseHandler", {scrollSpeed: {initialValue: 2}, dragDelay: {initialValue: 150}, dragEnabled: {initialValue: !0}, focusTimout: {initialValue: 0}}), t.MouseHandler = l
    ...
    function s(e) {
        ...
        function h(e) {
            ...
            if (e.y + 3 * t.renderer.lineHeight + 15 < n.bottom)u.style.bottom = "", u.style.top = e.y + 15 + "px"; else {
                u.style.top = "";
    ...
    function f(e) {
        ...
        function N(e, n) {
            var r = (new Date).getTime(), i = t.renderer.layerConfig.lineHeight, s = t.renderer.layerConfig.characterWidth, u = t.renderer.scroller.getBoundingClientRect(), a = {x: {left: p - u.left, right: u.right - p}, y: {top: d - u.top, bottom: u.bottom - d}}, f = Math.min(a.x.left, a.x.right), l = Math.min(a.y.top, a.y.bottom), c = {row: e.row, column: e.column};
    ...
    (function () {
        ...
        r.implement(this, o), this.setDocument = function (e) {
            ...
            if (this.$wrapLimitRange.min !== e || this.$wrapLimitRange.max !== t)this.$wrapLimitRange = {min: e, max: t}, this.$modified = !0, this._emit("changeWrapMode")
    ...
    function u() {
        this.getFoldAt = function (e, t, n) {
            ...
            if (t)this.removeFolds(i); else while (i.length)this.expandFolds(i), i = this.getFoldsInRangeList(n)
            ...
            for (var i = e; i < t; i++) {
                ...
                if (s && s.isMultiLine() && s.end.row <= t && s.start.row >= e)try {
    ...
    t.commands = [
        ...
        }, multiSelectAction: "forEach", readOnly: !0, group: "fileJump"},
    ...
    var m = function (e, t) {
        ...
        }), this.scrollTop = 0, this.scrollLeft = 0, this.cursorPos = {row: 0, column: 0}, this.$textLayer.addEventListener("changeCharacterSize", function () {
    ...
    (function () {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, d), this.updateCharacterSize = function () {
            ...
            return this.layerConfig = {width: o, padding: this.$padding, firstRow: h, firstRowScreen: d, lastRow: p, lineHeight: m, characterWidth: this.characterWidth, minHeight: s, maxHeight: r, offset: i, height: this.$size.scrollerHeight}, this.$gutterLayer.element.style.marginTop = -i + "px", this.content.style.marginTop = -i + "px", this.content.style.width = o + 2 * this.$padding + "px", this.content.style.height = s + "px", y
            ...
            this.$scrollAnimation = {from: e, to: n, steps: s}, clearInterval(this.$timer), r.session.setScrollTop(s.shift()), this.$timer = setInterval(function () {
    ...
    (function () {
        i.implement(this, o), this.setSession = function (e) {
            ...
            if (this.$fixedWidth || i.$useWrapMode)c = i.getLength();
    ...
    (function () {
        r.implement(this, u), this.EOF_CHAR = "¶", this.EOL_CHAR = "¬", this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.setPadding = function (e) {
            ...
            var r = this.$measureNode.getBoundingClientRect(), o = {height: r.height, width: r.width / 100};
            ...
            for (; ;) {
                ...
                if (this.$useLineGroups())a.className = "ace_line_group", r.appendChild(a), a.style.height = e.lineHeight * this.session.getRowLength(s) + "px"; else {
                    var l = a.childNodes;
    ...
    var r = e("../lib/oop"), i = e("../lib/event_emitter").EventEmitter, s = e("../config"), o = function (t, n, r) {
        ...
        this.$worker = new Worker(i), this.$worker.postMessage({init: !0, tlns: u, module: n, classname: r}), this.callbackId = 1, this.callbacks = {}, this.$worker.onmessage = this.onMessage
    };
    (function () {

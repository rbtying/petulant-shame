...
}), ace.define("ace/mode/d_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        this.$rules = {start: [
            {token: "punctuation.definition.comment.d", regex: "/\\*\\*/"},
            {include: "text.html.javadoc"},
            {token: ["meta.definition.class.d", "storage.modifier.d", "storage.type.structure.d", "meta.definition.class.d", "entity.name.type.class.d", "meta.definition.class.d", "meta.definition.class.d", "storage.type.template.d", "meta.definition.class.d", "meta.definition.class.d", "meta.definition.class.d", "punctuation.separator.inheritance.d", "meta.definition.class.d", "entity.other.inherited-class.d", "meta.definition.class.d", "entity.other.inherited-class.d", "meta.definition.class.d", "entity.other.inherited-class.d", "meta.definition.class.d", "entity.other.inherited-class.d", "meta.definition.class.d", "entity.other.inherited-class.d", "meta.definition.class.d", "entity.other.inherited-class.d", "meta.definition.class.d", "entity.other.inherited-class.d"], regex: "^(\\s*)((?:\\b(?:public|private|protected|static|final|native|synchronized|abstract|export)\\b\\s*)*)(class|interface)(\\s+)(\\w+)(\\s*)(?:(\\(\\s*)([^\\)]+)(\\s*\\))|)(\\s*)(?:(\\s*)(:)(\\s*)(\\w+)(?:(\\s*,\\s*)(\\w+))?(?:(\\s*,\\s*)(\\w+))?(?:(\\s*,\\s*)(\\w+))?(?:(\\s*,\\s*)(\\w+))?(?:(\\s*,\\s*)(\\w+))?(?:(\\s*,\\s*)(\\w+))?)?", push: [
                {token: "meta.definition.class.d", regex: "(?={)", next: "pop"},
                {token: "storage.modifier.d", regex: "\\b(?:_|:)\\b", push: [
            ...
            {token: ["meta.definition.struct.d", "storage.modifier.d", "storage.type.structure.d", "meta.definition.struct.d", "entity.name.type.struct.d", "meta.definition.struct.d", "meta.definition.struct.d", "storage.type.template.d", "meta.definition.struct.d", "meta.definition.struct.d"], regex: "^(\\s*)((?:\\b(?:public|private|protected|static|final|native|synchronized|abstract|export)\\b\\s*)*)(struct)(\\s+)(\\w+)(\\s*)(?:(\\(\\s*)([^\\)]+)(\\s*\\))|)(\\s*)", push: [
                {token: "meta.definition.struct.d", regex: "(?={)", next: "pop"},
                {token: "storage.modifier.d", regex: "\\b(?:_|:)\\b", push: [
                    {token: [], regex: "(?={)", next: "pop"},
                    {include: "#all-types"},
                    {defaultToken: "meta.definition.class.extends.d"}
            ...
            {token: ["meta.definition.constructor.d", "storage.modifier.d", "entity.name.function.constructor.d", "meta.definition.constructor.d"], regex: "^(\\s*)((?:\\b(?:public|private|protected|static|final|native|synchronized|abstract|threadsafe|transient|export)\\b\\s*)*)(\\bthis)(\\s*)(?!.*;)(?=\\()"},
            {token: ["storage.modifier.d", "entity.name.function.destructor.d", "meta.definition.destructor.d", "meta.definition.destructor.d"], regex: "(?:^|)((?:\\b(?:public|private|protected|static|final|native|synchronized|abstract|threadsafe|transient|export)\\b\\s*)*)(~this)(\\s*)(\\()", TODO: "(?<!else|new|=) were disallowed in original regex"},
            {token: ["meta.definition.method.d", "storage.modifier.d", "storage.type.structure.d", "meta.definition.method.d", "entity.name.function.d", "meta.definition.method.d"], regex: "^(\\s*)((?:\\b(?:public|private|protected|static|final|native|lazy|synchronized|abstract|threadsafe|transient|export)\\b\\s*)*)(\\b(?:void|boolean|byte|char|short|int|float|long|double|[\\w_]+[\\w0-9_]*|(?:\\w+\\.)*[A-Z]\\w+)\\b(?:<(?:(?:\\w+\\.)*[A-Z]\\w+(?:\\s*,\\s*)?)+>|(?:\\[\\s*\\])*)?)(\\s*)(\\w+)(\\s*)(?!.*;)(?=\\()"},
            {token: "constant.other.d", regex: "\\b[A-Z][A-Z0-9_]+\\b"},
            {include: "#comments"},
            {include: "#all-types"},
            {token: "storage.modifier.access-control.d", regex: "\\b(?:private|protected|public|export)\\b"},
            {token: "storage.modifier.d", regex: "\\b(?:auto|static|override|final|const|abstract|volatile|synchronized|lazy)\\b"},
            {token: "storage.type.structure.d", regex: "\\b(?:template|interface|class|enum|struct|union)\\b"},
            {token: "storage.type.d", regex: "\\b(?:ushort|int|uint|long|ulong|float|void|byte|ubyte|double|bit|char|wchar|ucent|cent|short|bool|dchar|real|ireal|ifloat|idouble|creal|cfloat|cdouble|lazy)\\b"},
            {token: "keyword.control.exception.d", regex: "\\b(?:try|catch|finally|throw)\\b"},
            {token: "keyword.control.d", regex: "\\b(?:return|break|case|continue|default|do|while|for|switch|if|else)\\b"},
            {token: "keyword.control.conditional.d", regex: "\\b(?:if|else|switch|iftype)\\b"},
            {token: "keyword.control.branch.d", regex: "\\b(?:goto|break|continue)\\b"},
            {token: "keyword.control.repeat.d", regex: "\\b(?:while|for|do|foreach(?:_reverse)?)\\b"},
            {token: "keyword.control.statement.d", regex: "\\b(?:version|return|with|invariant|body|scope|in|out|inout|asm|mixin|function|delegate)\\b"},
            {token: "keyword.control.pragma.d", regex: "\\bpragma\\b"},
            {token: "keyword.control.alias.d", regex: "\\b(?:alias|typedef)\\b"},
            {token: "keyword.control.import.d", regex: "\\bimport\\b"},
            {token: ["meta.module.d", "keyword.control.module.d", "meta.module.d", "entity.name.function.package.d", "meta.module.d"], regex: "^(\\s*)(module)(\\s+)([^ ;]+?)(;)"},
            {token: "constant.language.boolean.d", regex: "\\b(?:true|false)\\b"},
            {token: "constant.language.d", regex: "\\b(?:__FILE__|__LINE__|__DATE__|__TIME__|__TIMESTAMP__|null)\\b"},
            {token: "variable.language.d", regex: "\\b(?:this|super)\\b"},
            {token: "constant.numeric.d", regex: "\\b(?:0(?:x|X)[0-9a-fA-F]*|(?:[0-9]+\\.?[0-9]*|\\.[0-9]+)(?:(?:e|E)(?:\\+|-)?[0-9]+)?)(?:[LlFfUuDd]|UL|ul)?\\b"},
            {include: "#string_escaped_char"},
            {include: "#strings"},
            {token: "keyword.operator.comparison.d", regex: "==|!=|<=|>=|<>|<|>"},
            {token: "keyword.operator.increment-decrement.d", regex: "\\-\\-|\\+\\+"},
            {token: "keyword.operator.arithmetic.d", regex: "\\-|\\+|\\*|\\/|~|%"},
            {token: "keyword.operator.logical.d", regex: "!|&&|\\|\\|"},
            {token: "keyword.operator.overload.d", regex: "\\b(?:opNeg|opCom|opPostInc|opPostDec|opCast|opAdd|opSub|opSub_r|opMul|opDiv|opDiv_r|opMod|opMod_r|opAnd|opOr|opXor|opShl|opShl_r|opShr|opShr_r|opUShr|opUShr_r|opCat|opCat_r|opEquals|opEquals|opCmp|opCmp|opCmp|opCmp|opAddAssign|opSubAssign|opMulAssign|opDivAssign|opModAssign|opAndAssign|opOrAssign|opXorAssign|opShlAssign|opShrAssign|opUShrAssign|opCatAssign|opIndex|opIndexAssign|opCall|opSlice|opSliceAssign|opPos|opAdd_r|opMul_r|opAnd_r|opOr_r|opXor_r)\\b"},
            {token: "keyword.operator.d", regex: "\\b(?:new|delete|typeof|typeid|cast|align|is)\\b"},
            {token: "keyword.other.class-fns.d", regex: "\\b(?:new|throws)\\b"},
            {token: "keyword.other.external.d", regex: "\\b(?:package|extern)\\b"},
            {token: "keyword.other.debug.d", regex: "\\b(?:deprecated|unittest|debug)\\b"},
            {token: "support.type.sys-types.c", regex: "\\b(?:u_char|u_short|u_int|u_long|ushort|uint|u_quad_t|quad_t|qaddr_t|caddr_t|daddr_t|dev_t|fixpt_t|blkcnt_t|blksize_t|gid_t|in_addr_t|in_port_t|ino_t|key_t|mode_t|nlink_t|id_t|pid_t|off_t|segsz_t|swblk_t|uid_t|id_t|clock_t|size_t|ssize_t|time_t|useconds_t|suseconds_t)\\b"},
            {token: "support.type.pthread.c", regex: "\\b(?:pthread_attr_t|pthread_cond_t|pthread_condattr_t|pthread_mutex_t|pthread_mutexattr_t|pthread_once_t|pthread_rwlock_t|pthread_rwlockattr_t|pthread_t|pthread_key_t)\\b"},
            {token: "support.type.stdint.c", regex: "\\b(?:int8_t|int16_t|int32_t|int64_t|uint8_t|uint16_t|uint32_t|uint64_t|int_least8_t|int_least16_t|int_least32_t|int_least64_t|uint_least8_t|uint_least16_t|uint_least32_t|uint_least64_t|int_fast8_t|int_fast16_t|int_fast32_t|int_fast64_t|uint_fast8_t|uint_fast16_t|uint_fast32_t|uint_fast64_t|intptr_t|uintptr_t|intmax_t|intmax_t|uintmax_t|uintmax_t)\\b"}
        ], "#all-types": [
            {include: "#support-type-built-ins-d"},
            {include: "#support-type-d"},
            {include: "#storage-type-d"}
        ], "#comments": [
            {token: "punctuation.definition.comment.d", regex: "/\\*", push: [
                {token: "punctuation.definition.comment.d", regex: "\\*/", next: "pop"},
            ...
            {token: ["punctuation.definition.comment.d", "comment.line.double-slash.d"], regex: "(//)(.*$)"}
        ], "#constant_placeholder": [
            {token: "constant.other.placeholder.d", regex: "%(?:\\([a-z_]+\\))?#?0?\\-?[ ]?\\+?(?:[0-9]*|\\*)(?:\\.(?:[0-9]*|\\*))?[hL]?[a-z%]", caseInsensitive: !0}
        ], "#regular_expressions": [
            {token: "constant.character.escape", regex: "\\\\."}
        ], "#statement-remainder": [
            {token: "meta.definition.param-list.d", regex: "\\(", push: [
                {token: "meta.definition.param-list.d", regex: "(?=\\))", next: "pop"},
                {include: "#all-types"},
                {defaultToken: "meta.definition.param-list.d"}
            ]},
            {token: "keyword.other.class-fns.d", regex: "throws", push: [
                {token: [], regex: "(?={)", next: "pop"},
                {include: "#all-types"},
                {defaultToken: "meta.definition.throws.d"}
            ]}
        ], "#storage-type-d": [
            {token: "storage.type.d", regex: "\\b(?:void|byte|short|char|int|long|float|double|boolean|(?:[a-z]\\w+\\.)*[A-Z]\\w+)\\b"}
        ], "#string_escaped_char": [
            {token: "constant.character.escape.d", regex: "\\\\(?:\\\\|[abefnprtv'\"?]|[0-3]\\d{,2}|x[0-9a-fA-F]{2}|u[0-9a-fA-F]{4}|U[0-9a-fA-F]{8}|&\\w+;)"},
            {token: "invalid.illegal.unknown-escape.d", regex: "\\\\."}
        ], "#strings": [
            {token: "punctuation.definition.string.begin.d", regex: '"', push: [
                {include: "#string_escaped_char"},
                {token: "punctuation.definition.string.end.d", regex: '"', next: "pop"},
                {defaultToken: "string.quoted.double.d"}
            ]},
            {token: ["storage.type.string.d", "punctuation.definition.string.begin.d"], regex: '(r)(")', push: [
                {token: "punctuation.definition.string.end.d", regex: '"', next: "pop"},
